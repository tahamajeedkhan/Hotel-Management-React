...
router.route('/showBookings')
    .get(adminControler.getShowBookings);

router.route('/checkout')
    .get(adminControler.getCheckout)
    .post(adminControler.postCheckout);
router.route('/search')
    .get(adminControler.getSearch) // get request   
    .post(adminControler.postSearch) // post request

router.route('/searchemail')
    .get(adminControler.getSearchEmail) // get request 
    .post(adminControler.postSearchEmail)

router.post('/update', adminControler.getUpdate) //get update page for post request
